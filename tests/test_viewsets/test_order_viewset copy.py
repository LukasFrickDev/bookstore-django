...
class TestOrderViewSet(APITestCase):
    ...
    def setUp(self):
        ...
        self.product = ProductFactory(title='mouse', price=100.0, categories=[self.category])
    ...
    def test_order(self):
        ...
        self.assertEqual(float(order_data['results'][0]['product'][0]['price']), float(self.product.price))
